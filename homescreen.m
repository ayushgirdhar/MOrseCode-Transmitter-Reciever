...
% Last Modified by GUIDE v2.5 25-Aug-2016 13:20:39
...
% --- Executes on button press in tr1.
...
% --- Executes on button press in rc1.
function rc1_Callback(hObject, eventdata, handles)
% hObject    handle to rc1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global ser
fprintf(ser,'%c',']');
...
global ser
fclose(ser);
set(handles.text2,'string','Disconnect');